...
export default function ChatShow({ conversation, messages: initialMessages }: Props) {
    ...
    // Sử dụng usePage để lấy user data một cách chính xác
    ...
    const otherUser = conversation.customer?.id === user.id 
        ? conversation.seller 
        : conversation.customer;

    // Kiểm tra otherUser tồn tại
    if (!otherUser) {
    ...
    return (
        <AppLayout>
            <Head title={`Chat với ${otherUser.name}`} />
