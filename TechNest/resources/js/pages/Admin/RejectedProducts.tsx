...
export default function RejectedProducts({ products }: Props) {
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Sản phẩm bị từ chối', href: '/admin/products/rejected' },
            ]}
        >
            <Head title="Sản phẩm bị từ chối" />
            <div className="max-w-6xl mx-auto p-6">
                <h1 className="text-2xl font-bold mb-6">Sản phẩm bị từ chối</h1>
